                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Uid </th><td> {{ $order->uid }} </td></tr><tr><th> Pid </th><td> {{ $order->pid }} </td></tr><tr><th> Aid </th><td> {{ $order->aid }} </td></tr><tr><th> Qty </th><td> {{ $order->qty }} </td></tr><tr><th> Shipping Methods </th><td> {{ $order->shipping_methods }} </td></tr><tr><th> Promotional Code </th><td> {{ $order->	promotional_code }} </td></tr>
                                </tbody>
                            </table>
                        </div>
